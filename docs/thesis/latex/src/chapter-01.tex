...
Chapter 4 reports the implementation and configuration details of the architecture. This chapter maps conceptual components to concrete service behavior, explains how curation and retrieval are realized in code, and clarifies how externalized configuration influences execution and reproducibility.

Chapter 5 describes the deployment and execution model of the platform. It explains how the services are provisioned locally, how runtime dependencies are separated, and how execution-environment choices such as CUDA-based evaluation affect operational reproducibility.

Chapter 6 defines the experimental methodology. It specifies evaluation objectives, dataset protocols, and the reproducibility strategy, ensuring that empirical claims in later chapters can be interpreted within a transparent framework.
