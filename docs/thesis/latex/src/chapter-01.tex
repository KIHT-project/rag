...
Appendix A provides supplementary material covering repository structure, configuration and deployment excerpts, evaluation-pipeline details, Engineering Wiki integration, reproducibility notes, and the observed Label Studio export structure.
