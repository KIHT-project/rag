...
python -m evaluation_metrics.src.eval_cli \
  ...
  phase2_overlap \
  --phase1-pool-jsonl evaluation_metrics/runs/REPLACE_WITH_THE_PATH/phase1_pool.jsonl \
...
RUN=/Users/nchaikalis/IdeaProjects/rag/evaluation_metrics/runs/REPLACE_WITH_THE_PATH
